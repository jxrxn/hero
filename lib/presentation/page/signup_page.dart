// lib/presentation/page/signup_page.dart
import 'dart:ui';
...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> _doSignup() async {
    ...
    try {
      ...
      // Firebase loggar oftast in automatiskt efter signup.
      ...
      ScaffoldMessenger.of(context)
        ...
        ..showSnackBar(
          SnackBar(
            content: Text('Kunde inte skapa konto: $e'),
                    ...
                    child: AutofillGroup(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Sign up to start building your crew.',
                            textAlign: TextAlign.center,
